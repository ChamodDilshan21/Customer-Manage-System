package edu.icet.service.implementation;
...
public class CustomerServiceImpl implements CustomerService {
    ...
    public List<Customer> searchByAddress(String address) {
        List<CustomerEntity> byAddress = repository.searchByAddress(address);
        List<Customer> customerList = new ArrayList<>();
    ...
    public List<Customer> searchBySalary(Double salary) {
        List<CustomerEntity> bySalary = repository.getBySalary(salary);
        List<Customer> customerList = new ArrayList<>();
        bySalary.forEach(customerEntity -> customerList.add(mapper.map(customerEntity,Customer.class)));
        return customerList;
    }
